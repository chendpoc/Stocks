...
docs/research-agent/**/*.md           # 系统设计与旧路线资料
...
- `docs/research-agent/modules/` 是历史资料，可作为迁移素材，不作为目标系统权威路线。
- `docs/research-agent/**/*.md` 可以进入 artifact catalog 供人工检索，但默认 `memory_eligible = false`，不得自动生成金融 memory candidate。
