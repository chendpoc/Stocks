...
- `docs/research-agent/target-system/trader-agent/README.md`
- `docs/research-agent/target-system/trader-agent/00-workflow-router.md`
- `docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-prd.md`
- `docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/README.md`
- `docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/00e-workflow-and-skill-routing.md`
- `docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/00b-visual-design-review-workflow.md`
- `docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/01-design-style-and-interaction-principles.md`
