...
| --- | --- | --- | --- |
| Phase 1 board | `docs/research-agent/modules/2026-05-23-cursor-opportunity-board-prd.md` | Implementation has landed in the working tree. Code-level verification passed after main-agent readability fixes. | Hold for visual QA or small copy/layout fixes only. |
| Phase 2 detail | `docs/research-agent/modules/2026-05-23-cursor-opportunity-detail-prd.md` | Implementation has landed in the working tree. Code-level verification passed after main-agent readability fixes. | Hold for visual QA or bounded evidence-display polish only. |
| Phase 4 agent panel readability | `docs/research-agent/modules/2026-05-23-cursor-agent-panel-readability-prd.md` | Implementation has landed in the working tree. Main-agent review fixed remaining mojibake copy. | Hold for visual QA; do not add agent behavior in this lane. |
| Phase 5 review and learning | `docs/research-agent/modules/2026-05-23-codex-review-learning-records-prd.md` | Codex-agent PRD ready. Not a Cursor implementation lane yet. | Keep in Codex-agent queue unless a future low-decision UI subtask is split out. |
| Protected deployment | `docs/research-agent/modules/2026-05-23-research-console-deployment-boundary.md` and related audit docs. | Boundary documented, not a Cursor implementation task. | Keep separate from local workbench UI. |
...
- Phase 5 implementation ownership is delegated through `docs/research-agent/codex-agent-execution-queue.md`, not this Cursor queue.
