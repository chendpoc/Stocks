...
docs/research-agent/target-system/trader-agent/00-system-overview.md
docs/research-agent/target-system/trader-agent/01-agent-core-backend-prd.md
docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-prd.md
docs/research-agent/target-system/trader-agent/03-shared-platform-roadmap-prd.md
```
...
```text
docs/research-agent/modules/YYYY-MM-DD-<module>.md
```
...
- `docs/research-agent/cursor-execution-queue.md`
- `docs/research-agent/codex-agent-execution-queue.md`
