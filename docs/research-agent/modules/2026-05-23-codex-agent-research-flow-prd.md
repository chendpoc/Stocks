...
```text
Implement the next task from docs/research-agent/modules/2026-05-23-codex-agent-research-flow-prd.md.

Start by reading the PRD, docs/research-agent/opportunity-reasoning.md, docs/research-agent/tooling.md, apps/research-console/lib/agent-kernel.ts, apps/research-console/lib/agent-provider.ts, apps/research-console/lib/agent-evidence.ts, and packages/summary-core/src/index.ts.
