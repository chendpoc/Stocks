...
所有 spec / task / decision 持久化在 `.agent-dev/` 目录下。详见 `docs/workflow.md` 与 `.agent-dev/README.md`。
...
| 文档 | 路径 | 说明 |
|---|---|---|
| 系统设计 v0.3 | `docs/trader_agent_system_design_v0_3.md` | 三层架构全景 — Brain / Cockpit / Platform |
| Forward Market Intelligence 设计 | `docs/01-forward-market-intelligence-system-design.md` | intel 子系统详细设计 |
| MVP 模块开发指导 | `docs/02-mvp-module-development-plan.md` | 技术栈选型 + Phase 规划 |
| MVP 实施计划 | `docs/03-forward-market-intel-mvp-plan.md` | 10 个预决策 + 项目结构 + Phase 验收 |
| Agent Dev Workflow v2 | `docs/workflow.md` | Spec-Driven 完整流程（最终确认版） |
