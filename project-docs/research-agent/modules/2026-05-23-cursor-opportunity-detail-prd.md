...
```text
Implement Task 1 only from project-docs/research-agent/modules/2026-05-23-cursor-opportunity-detail-prd.md.
...
```text
Implement Task 2 only from project-docs/research-agent/modules/2026-05-23-cursor-opportunity-detail-prd.md.
...
```text
Implement Task 3 only from project-docs/research-agent/modules/2026-05-23-cursor-opportunity-detail-prd.md.
