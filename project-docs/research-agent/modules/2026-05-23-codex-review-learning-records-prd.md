...
```text
Implement the next task from project-docs/research-agent/modules/2026-05-23-codex-review-learning-records-prd.md.

Start by reading the PRD, project-docs/research-agent/trading-workbench-master-plan.md, apps/research-console/components/research/ResearchInspector.tsx, apps/research-console/app/api/research/opportunities/route.ts, apps/research-console/lib/opportunity-board.ts, and packages/summary-core/src/index.ts.
