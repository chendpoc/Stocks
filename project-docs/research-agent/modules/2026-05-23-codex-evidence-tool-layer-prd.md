...
```text
Implement the next task from project-docs/research-agent/modules/2026-05-23-codex-evidence-tool-layer-prd.md.

Start by reading the PRD, project-docs/research-agent/tooling.md, apps/research-console/lib/agent-tools.ts, apps/research-console/lib/tool-policy.ts, apps/research-console/lib/agent-evidence.ts, and packages/summary-core/src/index.ts.
