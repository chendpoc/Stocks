...
| `project-docs/research-agent/target-system/**/*.md` | `prd` | 0 | product/architecture source, not memory candidate |
| `project-docs/research-agent/**/*.md` | `engineering_doc` | 0 | engineering doc, not memory candidate |
...
| marks target-system PRD ineligible | temp repo `project-docs/research-agent/target-system/x.md` | source_type=`prd`, memory_eligible=0 |
...
```text
Implement plan 00 from project-docs/research-agent/target-system/trader-agent/03-shared-agent-memory-development/plans/00-m0-artifact-catalog.md.
...
Source of truth:
- project-docs/research-agent/target-system/trader-agent/03-shared-agent-memory-prd.md
- project-docs/research-agent/target-system/trader-agent/03-shared-agent-memory-development/01-source-artifact-catalog.md
