...
```text
Implement Task 1 from project-docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/plans/05-real-readonly-adapter.md.
...
```text
Implement Task 2 from project-docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/plans/05-real-readonly-adapter.md.
...
```text
Verify Tasks 1-2 from project-docs/research-agent/target-system/trader-agent/02-web-agent-cockpit-development/plans/05-real-readonly-adapter.md.
