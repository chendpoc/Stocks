...
The current goal is the trading research workbench defined in `project-docs/research-agent/trading-workbench-master-plan.md`.

The current Phase 1 module is `project-docs/research-agent/modules/2026-05-23-summary-to-opportunity-board.md`.
...
```text
Implement Task 1 only from project-docs/research-agent/modules/2026-05-23-cursor-opportunity-board-prd.md.
...
```text
Implement Task 2 only from project-docs/research-agent/modules/2026-05-23-cursor-opportunity-board-prd.md.
...
```text
Implement Task 3 only from project-docs/research-agent/modules/2026-05-23-cursor-opportunity-board-prd.md.
